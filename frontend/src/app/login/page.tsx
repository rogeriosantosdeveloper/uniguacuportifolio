            ...
            <div className="px-8 py-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-right">
                  <Link 
                    href="/esqueci-senha" 
                    className="text-sm text-uniguacu-blue hover:text-uniguacu-red transition-colors duration-200 font-medium"
                  >
                    Esqueceu sua senha?
                  </Link>
                </div>
          ...
          <div className="hidden lg:block space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">Portfólio Acadêmico</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Explore Projetos</h3>
                    <p className="text-sm text-gray-600">Descubra trabalhos acadêmicos incríveis dos nossos alunos</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Conheça os talentos e perfis dos estudantes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Compartilhe</h3>
                    <p className="text-sm text-gray-600">Apresente seus projetos e conquiste reconhecimento</p>
                  </div>
                </div>
              </div>
            </div>
